 ...
 * To be honest forgot why I made this....
 * To long ago..
 */
public class StartScreenNewLayout implements ActionListener {
    ...
    public StartScreenNewLayout() {

        startScreenFrame = new JFrame("Adyen Report Merger");
        startScreenFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        startScreenFrame.setSize(new Dimension(1200, 400));
        ...
        panelHolder[6][3].add(reportUserNameError);
